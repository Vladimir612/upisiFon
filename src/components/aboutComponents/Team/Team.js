  ...
  return (
    <div className={styles.team}>
      ...
      <div className={styles.cards}>
        <Person
          img={data.bojan.childImageSharp.gatsbyImageData}
        ...
        />
        <Person
          img={data.natalija.childImageSharp.gatsbyImageData}
        ...
        />
        <Person
          img={data.vlada.childImageSharp.gatsbyImageData}
        ...
        <Person
          img={data.kaca.childImageSharp.gatsbyImageData}
          name="Katarina Antić"
          role="CONTENT WRITER"
